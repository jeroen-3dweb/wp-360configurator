...
class DWeb_PS {
	...
	private function loadDependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/api/class-3dweb-ps-api.php'; //API Configurator
	...
	private function define_admin_hooks() {
		...
		register_activation_hook( DWEB_PS_MAIN_URL, [ $plugin_admin, 'activation' ] );
		register_deactivation_hook( DWEB_PS_MAIN_URL, [ $plugin_admin, 'de_activation' ] );
