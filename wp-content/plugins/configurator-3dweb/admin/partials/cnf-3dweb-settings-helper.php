...
function cnf_3dweb_setting_create_row($label, $description, $name, $value, $type = 'number')
{
    $checked = '';
    if ($type === 'checkbox') {
            ...
            <div class="cnf-3dweb__settings__row">
                    ...
                    <div class="cnf-3dweb__settings-holder">
                        <input class="regular-text ltr" type="%s"
                               ...
                               %s
                               value="%s"/>
                        <small class="cnf-3dweb-settings__settings-holder__description">%s. </small>
                    </div>
                </div>
      ',
...
// create select box
function cnf_3dweb_setting_create_select($label, $description, $name, $value, $options)
{
